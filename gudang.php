    ...
    <div class="container-fluid">
      ...
      <div class="row my-2">
        <div class="col-md">
          ...
          <a href="export.php" class="btn btn-success"> <i class="bi bi-file-earmark-spreadsheet-fill"></i>Export</a>
        </div>
      </div>
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <a href="edit.php?id=<?php echo $x['id']; ?>&aksi=edit" class="btn btn-success btn-sm" style="font-weight: 600;"><i class=" fas fa-edit"></i>Edit</a>
                    <a href="proses.php?id=<?php echo $x['id']; ?>&aksi=hapus" class="btn btn-danger btn-sm" style="font-weight: 600;"><i class=" fas fa-trash"></i>Hapus</a>
                  </td>
                </tr>
              <?php
              }
