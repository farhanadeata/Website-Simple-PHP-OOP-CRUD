...
class Db
{
     ...
     function input($kode_barang, $nama_barang, $jenis_barang, $stok, $catatan, $tgl_update)
     {

          mysqli_query($this->conn, "INSERT INTO gudang VALUES ('','$kode_barang','$nama_barang','$jenis_barang','$stok','$catatan','$tgl_update')");
     }
     ...
     function update($id, $kode_barang, $nama_barang, $jenis_barang, $stok, $catatan, $tgl_update)
     {

          mysqli_query($this->conn, "UPDATE gudang SET kode_barang='$kode_barang',nama_barang='$nama_barang',jenis_barang='$jenis_barang',stok='$stok',catatan='$catatan',tgl_update='$tgl_update' WHERE gudang . id='$id'");
     }
